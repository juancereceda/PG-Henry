        ...
        <Booking>
            ...
            <div className="row">
                ...
                <div className="col">
                    ...
                    <p>{selectedBook.date} at {selectedBook.time}</p>
                </div>
            </div>
            <div className="row">
                <div className="col">
                ...
                <div className="col">
                        ...
                        <ul>
                            {selectedBook.extras.length > 0 ? selectedBook.extras.map(ele => <li>{ele}</li>) : <li>No extras</li>}
                        </ul>
                </div>
            </div>
            <div className="row">
                ...
                <div className="col">
                    ...
                    <p className="war">This works as a <i>receipt</i>. Show it in the entrance.</p>
                </div>
            </div>
        </Booking>
    )
